...
My approach does not begin with formulating a goal, but with formulating a **larger vision**.
...
Based on this, a goal is formulated that takes a small step towards the next vision.
